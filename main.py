...
if __name__ == "__main__":
    instance_path = "datasets/a/instance_0012.txt"
    ...
    for solver_info in solvers:
        ...
        if result is not None:
            print(f"{solver_info['name']}: {result['objective']}")
        else:
            print(f"{solver_info['name']}: (timeout or error).")
