...
class GreedyOrderSimilarityAggregationHeuristic(Algorithm):
    ...
    @property
    def name(self) -> str:
        return "greedy_order_similarity_aggregation"
    ...
    def solve(self, instance: ProblemInput) -> dict:
        ...
        while selected_orders:
            ...
            if self._is_demand_fully_covered(demand, selected_aisles):
                ...
                objective = total_items / len(selected_aisles)
                return {'selected_orders': selected_orders, 'visited_aisles': selected_aisles, 'objective': objective}
